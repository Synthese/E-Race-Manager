...
<div class="container">
<div class="card">
<div class="card-header"><b>Fahrer hinzufügen</b></div>
...
<tr>
    <td>Photo (optional)<br>
    Bild durch Admin hochladen<br> lassen nach images/driver:</td>
	<td>
	<input type="link" name="driver_photo" value="<?php echo $item['driver_photo']?>" maxlength="200">
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
