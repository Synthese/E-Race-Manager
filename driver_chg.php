<?php 
/*
 * driver_chg.php  Version 1.11.0.0
 * date 08.05.19
 * 
 *
 */
...
<div class="container">
<div class="card">
<div class="card-header"><b>Fahrer aktualisieren</b></div>
...
<tr>
    ...
    <td>Photo:</td>
	<td><input type="link" name="driver_photo" value="<?php echo $item['driver_photo']?>" maxlength="200"></td>
</tr>
<tr>
	<td colspan="3"><b>Mitglied in (<?php echo $teamcount?>) Teams:</td>
	<td>
	<?php while($titem = mysqli_fetch_array($tresult)) { ?>
		<a href="?page=team_driver_rem&amp;id=<?php echo $titem['id']?>"><img src="images/page/delete16.png" alt="delete"></a> <?php echo $titem['teamname']?><br>
		(Fahrer entfernen)<br>
	<?php } ?>
	</td>
</tr>
